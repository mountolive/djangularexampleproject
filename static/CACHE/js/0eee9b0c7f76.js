...
function($locationProvider){$locationProvider.html5Mode(true);$locationProvider.hasPrefix('!');}})();;(function(){'use strict';angular.module('mountolive.routes').config(config);config.$inject=['$routeProvider'];function config($routeProvider){$routeProvider.when('/register',{controller:'RegisterController',controllerAs:'vm',templateUrl:'/static/template/authentication/register.html',}).otherwise('/');}})();;(function(){'use strict';angular.module('mountolive.authentication',['mountolive.authentication.controllers','mountolive.authentication.services']);angular.module('mountolive.authentication.controllers',[]);angular.module('mountolive.authentication.services',['ngCookies']);})();;(function(){'use strict';angular.module('mountolive.authentication.services').factory('Authentication',Authentication);Authentication.$inject=['$cookies','$http'];function Authentication($cookies,$http){var Authentication={register:register};return Authentication;function register(email,password,username){return $http.post('/api/v1/accounts/',{username:username,password:password,email:email});}}})();;(function(){'use strict';angular.module('mountolive.authentication.controllers').controller('RegisterController',RegisterController);RegisterController.$inject=['$location','$scope','Authentication'];function RegisterController($location,$scope,Authentication){var vm=this;vm.register=register;function register(){Authentication.register(vm.email,vm.password,vm.username);}}})();